...
species_to_plot = {'electrons','proton_beam'}; 
...
plots_dir = ['patric_density/den/',datadir,''];
...
figure(fig_number);
P.plot_field_density('ylinepos',[-0.005,0.005],'ylineflag',1,...
    'xlinepos',[0.423726],'xlineflag',0,...
    'include_density_profile',1,'include_field_lineout',0); %#ok<NBRAK> 
