...
datadir = 'DWexp30cm'; %''; DW_lcode_justelectron DW_justelectron
...
species = 'electron_seed';   %  electron_seed   proton_beam

% choose limits (in cm, must denormalize)
trans_range = [0 0.11];
xi_range = [19 0];
% xi_range = [19 0];
plot_density_lims = [0 3.5e10];
...
plots_dir = ['DW/fielden/','dw_exp30cm'];
