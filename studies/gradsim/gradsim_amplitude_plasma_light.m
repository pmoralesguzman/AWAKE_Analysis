...
% Calculate average of the fields in the last dump, to relate to the plasma
% light
%
% Osiris 4.4.4
%
...
ccrb = [ccrb(1:5,:);[0 0 0];[0 0 0];ccrb(6,:);[0.5 0.5 0.5];ccrb(7:end,:)];


run_it = 1; % run the code without loading data from cache

% datadirs = {'gm15','gm10','gm5','g0','gp1','gp1','gp5','gp10','gp15'};
datadirs = {'gm20','gm15','gm10','gm5','g0','gp1','gp2','gp5','gp7','gp10','gp15','gp20'};
grads_sim   = [-20,-15,-10,-5,0,1,2,5,7,10,15,20];
legends

% save file name
% plots_dir = ['gradsim/amplitude_last_dump'];
...
fig_amplitude = figure(6);
colororder(ccrb);
line_style = {':','--','-.','-','-','-','-','-','-','-.','--',':'};

hold on
for d = 1:length(datadirs)
%     scatter(grads_sim(d),amplitudes{d},20,ccrb(d,:),'filled');
