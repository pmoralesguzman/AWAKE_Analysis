...
%     'short bunch'};
datadirs = {'gp20','gp20'};
% legs = {'z = 3.8 m','z = 3.8 m (envelope)','z = 10 m','z = 10 m (envelope)'};
...
plots_dir = ['gradsim_paper/lineout/'];
...
%     P.plot_handle.LineWidth = 2;
    ...
    P.plot_name = ['microbunch',datadirs{1},'n',num2str(n)];
    P.fig_handle = gcf;
    ylabel('density (arb. unit)','FontSize',14)
    xlabel('\xi (cm)','FontSize',14)
    P.fig_handle.Children(1).FontSize = 14;
