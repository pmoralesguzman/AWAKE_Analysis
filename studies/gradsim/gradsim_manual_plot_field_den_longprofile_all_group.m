...
plot_position = [0.2857    0.0444    0.3979    0.4514];
...
%     ax_density_exp(d).YTickMode = 'manual';
    ...
    yline(sigma_rexp,'color',crimson,'LineWidth',2)
    yline(-sigma_rexp,'color',crimson,'LineWidth',2)
    yline(6*sigma_rexp,'color',navyblue,'LineWidth',2)
    yline(-6*sigma_rexp,'color',navyblue,'LineWidth',2)
    xline(12.809,'color',crimson,'linewidth',2)
...
%                 ax_density_exp(d).LineWidth = 1;
    ...
    plongprofile = plot(z_plot,long_profile,'k');
    xline(12.809,'color',crimson,'linewidth',2)
...
% v = [-fliplr(trans_lims),trans_lims]*10;
%     for vv = 1:length(v)
% 
%     yline(v(vv),'color',navyblue,'LineWidth',1)
%     end
