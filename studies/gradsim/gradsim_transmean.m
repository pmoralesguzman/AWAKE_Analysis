...
% ccrb = ccrb(5:end,:);
ccrb = [ccrb(1:5,:);[0 0 0];[0 0 0];ccrb(6:end,:)];

run_it = 1; % run the code without loading data from cache

datadirs = {'gm20','gm15','gm10','gm5','g0','gp1','gp2','gp5','gp10','gp15','gp20'};
% datadirs = {'g0'};

% save file name
plots_dir = ['gradsim/amplitude/all'];
...
ylabel(['mean defocusing fields (MV/m)'],'interpreter','latex');
addtextlines = true;
if addtextlines
    % Create textarrow
   % Create textarrow
...
% Create textarrow
annotation(fig_amplitude,'textarrow',[0.739288969917958 0.619872379216044],...
    [0.856447688564477 0.766423357664234],...
    'Color',[0.0390625 0.0390625 0.0390625],...
    'String','$g = 0.2$\,\%/m',...
    'LineWidth',1,...
    'Interpreter','latex',...
...
save(['loading_files/gradsim_cache/gradsim_fieldamplitude_',cache_dir,'_gp2.mat'],...
