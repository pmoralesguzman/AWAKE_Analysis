...
plots_dir = ['gradsim_convergence/ch/chvsgzxi/',''];
...
if run_it
    ...
    load('loading_files/gradsim_chargeinxi_convergence.mat');
end % if run it
...
save('loading_files/gradsim_chargeinxi_convergence.mat','plot_z','chargevsz');
