...
% Version for checking convergence
%
% Osiris 4.4.4
%
% AWAKE Experiment
...
% save directory
plots_dir = ['gradsim_convergence/fft/r/','n',num2str(dump),'r17'];
...
EDA = ExperimentalDataAnalyser('datadir',datadir(1:4),'plasmaden',plasma_density);
...
xlabel('x (mm)')
legend([s1 s2],'simulation','experiment','location','best');
