...
plots_dir = ['gradsim_paper/ch/wrvszxi'];
plot_name = ['wrvszxi'];
...
if run_it
    ...
    load('loading_files/gradsim_cache/gradsim_fieldamplitude_transmean_xi.mat')
end
...
save('loading_files/gradsim_cache/gradsim_fieldamplitude_transmean_xi.mat','plot_z','fieldvsz');
