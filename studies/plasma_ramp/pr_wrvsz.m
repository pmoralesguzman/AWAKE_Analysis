...
if run_it == 1
    ...
    load([OWA.datadir,'_fieldamplitude_transmean.mat']);
end % if run it
...
ylabel(['$W_{r,',OWA.search_type,'}$ (MV/m)'],'interpreter','latex');
addtextlines = 0;
if addtextlines
    % Create textarrow
...
save(['loading_files/',OWA.datadir,'_fieldamplitude_transmean.mat'],...
