...
datadir = 'r2l_302_c_e550'; %''; DW_lcode_justelectron DW_justelectron
extradatadir = 'r2l_302_c_pi_e550'; %'DWdc3_lcode_x1_pi'; DW_lcode_nofront
...
trans_range = [0 0.11];
xi_range = [30 0];
plot_density_lims = [0 4e10];
plot_field_lims = [-60 60];
...
plots_dir = ['eps2022/fielden/',datadir,'x'];
