...
datadir = 'eseedgrad2'; %'gradsim_shortbunch';
dataformat = 'h5';
useAvg = 1;
dump_list = 3:1:3;
...
plots_dir = ['opendays/field_density/',datadir];
...
figure(fig_number);
P.plot_field_density('ylinepos',[-0.04,0.04],'ylineflag',0,...
    'include_lineout',include_lineout);

title(P.fig_handle.Children.Children(3),['RIF at = ',num2str(P.dtime,2),' cm'])

P.plots_dir = 'eseedwakefields';
P.save_plot();
